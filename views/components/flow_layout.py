"""A wrapping flow layout (based on the canonical Qt example).

Lays widgets out left-to-right and wraps to the next line when horizontal
space runs out — giving responsive, reflowing card grids without manual
breakpoints.
"""
